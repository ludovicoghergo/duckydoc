...
public class LstAnswerAdapter extends ArrayAdapter<Answer> {

    Context context;
    int resource;
    List<Answer> lstAnswers;
    public LstAnswerAdapter(Context context, int resource, List<Answer> lstAnswers){
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView lblQuery = view.findViewById(R.id.lblQuery);
        ...
        lblQuery.setText(answer.getQuery().getText());
